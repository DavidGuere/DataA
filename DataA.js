...
function olderThan(ageLim){
    return function old(object){
        return object.age > ageLim
}
}

olderThan35 = olderThan(35)
...
function youngerThan(ageLim2){
    return function young(object){
        return object.age < ageLim2
    }
}
youngerThan64 = youngerThan(64)
...
youngerThan43 = youngerThan(43)
olderThan22 = olderThan(22)
men = gender('Male')
